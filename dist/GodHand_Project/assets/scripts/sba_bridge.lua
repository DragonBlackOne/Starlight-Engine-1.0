...
-- Self-tests are disabled by default to avoid heavy concurrent boot activity.
SBA_RUN_SELF_TESTS = SBA_RUN_SELF_TESTS or false
...
if SBA_RUN_SELF_TESTS == true then
    run_sba_self_tests()
end
