...
function Stage.init()
    ...
    -- 2. Spawn Destructible Props (Barrels and Crates) with Item Drops
    Stage.spawnBarrel(-6.5, 0.0, -4.0, "heal")
    Stage.spawnBarrel(6.5, 0.0, -4.0, "tension")
    Stage.spawnCrate(-8.5, 0.0, 4.0, "heal")
    Stage.spawnCrate(8.5, 0.0, 4.0, "tension")
    Stage.spawnBarrel(0.0, 0.0, 8.5, "heal")
    Stage.spawnCrate(-4.0, 0.0, 9.0, "tension")
    Stage.spawnCrate(4.0, 0.0, 9.0, "heal")
end
