...
tests\test_ricochet_v2.py:100: in test_win_condition
    game.update(0.16)
src\starlight\games\ricochet_v2\game.py:460: in update
    if self.window.width != self.menu_container.width or self.window.height != self.menu_container.height or self.window.width != self.renderer.width:
                            ^^^^^^^^^^^^^^^^^^^
E   AttributeError: 'TestRicochet' object has no attribute 'menu_container'. Did you mean: 'menu_ui_container'?
____________________________ test_collision_logic _____________________________
tests\test_ricochet_v2.py:120: in test_collision_logic
    game.update(0.16)
src\starlight\games\ricochet_v2\game.py:460: in update
    if self.window.width != self.menu_container.width or self.window.height != self.menu_container.height or self.window.width != self.renderer.width:
                            ^^^^^^^^^^^^^^^^^^^
...
tests\test_ricochet_v2.py:60
  D:\Projetos\Starlight-Engine alternative generation\tests\test_ricochet_v2.py:60: PytestCollectionWarning: cannot collect test class 'TestRicochet' because it has a __init__ constructor (from: tests/test_ricochet_v2.py)
    class TestRicochet(RicochetV2):

-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
=========================== short test summary info ===========================
FAILED tests/test_ricochet_v2.py::test_win_condition - AttributeError: 'TestR...
FAILED tests/test_ricochet_v2.py::test_collision_logic - AttributeError: 'Tes...
======================== 2 failed, 4 warnings in 0.46s ========================
