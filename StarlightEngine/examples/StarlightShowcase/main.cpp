...
public:
    ...
    void RenderUI() override {
        ImGui::Begin("Starlight Engine Inspector (Ported Systems)");
...
public:
    ...
    void RenderUI() override {
        ...
        char buf[128];
        sprintf(buf, "F3: Mudar Jogo | Atual: %s | Starlight Engine Arcade Suite", games[activeGameIdx]->GetName().c_str());
...
int main(int argc, char* argv[]) {
    (void)argc; (void)argv;
    WindowConfig config = { "Starlight Engine Showcase - Sovereign Edition", 1280, 720 };
    Engine engine;
