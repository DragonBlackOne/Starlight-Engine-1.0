...
# Skill: render-motion-blur

## Context
This skill is part of the "God Tier" expansion for Starlight Engine, aiming to provide Per-object Motion Blur.

## Goals
1. Implement the core logic for render-motion-blur.
2. Integrate with the existing systems.
3. Verify functionality with a test or demo.

## Implementation Steps
- [ ] Research best practices for render-motion-blur.
