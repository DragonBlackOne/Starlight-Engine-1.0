...
tests\test_ricochet_v2.py:105: in test_win_condition
    game.update(0.16)
src\starlight\games\ricochet_v2\game.py:647: in update
    self.audio.play_sound(self.announcer_excellent)
                          ^^^^^^^^^^^^^^^^^^^^^^^^
E   AttributeError: 'RicochetForTest' object has no attribute 'announcer_excellent'
____________________________ test_collision_logic _____________________________
tests\test_ricochet_v2.py:122: in test_collision_logic
    game.update(0.16)
src\starlight\games\ricochet_v2\game.py:642: in update
    self.audio.play_sound(self.announcer_ouch)
                          ^^^^^^^^^^^^^^^^^^^
E   AttributeError: 'RicochetForTest' object has no attribute 'announcer_ouch'
============================== warnings summary ===============================
